...
export const Sanitize = () => <Global styles={sanitize} />;

export const sanitizeForms = css`
  /**
  * 1. Change the inconsistent appearance in all browsers (opinionated).
...
export const SanitizeForms = () => <Global styles={sanitizeForms} />;

export const sanitizeTypography = css`
  /**
...
export const SanitizeTypography = () => <Global styles={sanitizeTypography} />;

export const sanitizePage = css`
  /**
...
export const SanitizePage = () => <Global styles={sanitizePage} />;
